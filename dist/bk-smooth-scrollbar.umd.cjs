(function(global2, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, global2.BKSmoothScrollbar = factory());
})(this, function() {
  "use strict";
  ...
  objectDefineProperties.f = DESCRIPTORS$9 && !V8_PROTOTYPE_DEFINE_BUG ? Object.defineProperties : function defineProperties(O, Properties) {
    ...
    var key;
    while (length > index2)
      definePropertyModule$4.f(O, key = keys2[index2++], props[key]);
    return O;
  };
  ...
  objectGetOwnPropertyDescriptor.f = DESCRIPTORS$7 ? $getOwnPropertyDescriptor : function getOwnPropertyDescriptor2(O, P) {
  ...
  var ownKeys$1 = getBuiltIn$3("Reflect", "ownKeys") || function ownKeys2(it) {
    var keys2 = getOwnPropertyNamesModule$1.f(anObject$6(it));
  ...
  var iterate$6 = function(iterable, unboundFunction, options) {
    ...
    while (!(step = call$4(next2, iterator)).done) {
      try {
  ...
  var iterateSimple$7 = function(record, fn, ITERATOR_INSTEAD_OF_RECORD) {
    ...
    var step, result;
    while (!(step = call$3(next2, iterator)).done) {
  ...
  var setIterate = function(set2, fn, interruptible) {
    return interruptible ? iterateSimple$6({ iterator: keys(set2), next }, fn) : forEach(set2, fn);
  };
...
//# sourceMappingURL=bk-smooth-scrollbar.umd.cjs.map
